<?php
	...
	try{
		...
		$query->execute(array($email, $phone, $address, $state, $city, $company, $_SESSION['searchUserName']));
		$contactMessage = urlencode("Contact edit successfull!");
		
		header('location: admin_edit_client_contact.php?contactMessage='.$contactMessage);
