## Getting Started
*To get started, open the sql file and dump that into your database. It has everything you need to create the tables and fill in the information if need be. If you just want empty tables, then only use the 'create table' statements. Once database is set up, download the source code and open it.
*Once the source code is opened, go ahead and replace the following $db information on all of the following pages
