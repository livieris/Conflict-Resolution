		...
		<div id="body">
			...
			<div class="section">
				...
				<div class="floatCenterText">
					<h2>
					<?php
						echo "Admin: ".$_SESSION['searchResultFirstName'] . " " . $_SESSION['searchResultLastName'] . " Client Note"; 
					?>
					</h2>
					<?php
			...
			<div id="loginDiv">
				...
				<!-- Here will print out from db and then submit changes-->
					<form class ="contactInfo" action="admin_edit_client_notes.php" method="post">
